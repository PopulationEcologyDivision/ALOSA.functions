...
age.num.matrix=GR$escape[GR$year==plotyear & !is.na(GR$year)]*age.prop.matrix/1000
 barplot(age.num.matrix[1:4,],ylim=c(0,max(sum(age.num.matrix[,2],na.rm=T)*1.2,sum(age.num.matrix[,3],na.rm=T)*1.2)),
        xlab="",ylab="Thousands of Fish",cex.lab=1.5,las=1,
...
**Figure 8.** Estimated number of Alewife by age and spawning history ascending the White Rock fish ladder in `r plotyears[1]`.

\newpage
```{r ageplot2,echo=FALSE, fig.width = 7.5,fig.height = 9}
plotyears=c(2018,2019)
...
**Figure 9.** Estimated number of Alewife by age and spawning history ascending the White Rock fish ladder in `r plotyears[1]` and `r plotyears[2]`. 
...
**Figure 10.** Estimated number of Alewife by age and spawning history ascending the White Rock fish ladder in `r plotyears[1]` and `r plotyears[2]`.

\newpage
```{r ageplot4,echo=FALSE, fig.width = 7.5,fig.height = 9}
...
**Figure 11.** Estimated number of Alewife by age and spawning history ascending the White Rock fish ladder in `r plotyears[1]` and `r plotyears[2]`.
...
**Figure 12.** Yield curve showing the relationship between the exploitation rate (the proportion of the spawning run harvested) and the yield from the fishery. The three zones correspond to the removal reference levels provided in Table 2. Adapted from Gibson et al. (2017).
