...
This document summarizes the daily counts of Gaspereau, a collective name for Alewife and Blueback Herring at three ladders in the Tusket River, Nova Scotia in the spring of 2022. The vast majority of spawning habitat for Alewife and Blueback Herring is upstream of the Lake Vaughan fishway and the Powerhouse fishway; those two ladders are "parallel" to each other, both providing access to Lake Vaughan. The Carleton Ladder, located at the north end of Lake Vaughan, allows fish to access the Carleton branch of the watershed, from Raynardton Lake and further upstream. Fish that exit the Lake Vaughan or Powerhouse ladder can also access the Quinan/Tusket branch of the watershed, where there are no fish ladders, and is thought to be totally accessible, with the exception of the Great Barren Lake which is dammed off without fish passage.

The total counts from the Lake Vaughan fish ladder are used to assess the Alewife population relative to reference points. It is also used to assess the Blueback Herring population. Counts from the Powerhouse ladder were not done in recent years, as it was thought that Gaspereau did not use that ladder. The counts conducted in the spring of 2022 generally supported that theory. While the counts at the Powerhouse ladder could be added to the totals used for the assessment, they are much smaller, and would not significantly change stock status.

Counts were completed following a two-way stratified random sampling design. Each day, a total of 24 five minute video blocks were counted. To ensure that parts of the day where fish ran heavy or not at all were represented, each day was broken into six sections, or strata, and four five minute video counts were sampled from each section. 

The four video counts were averaged, and that average was multiplied by the number of five minute blocks within each stratum (section) of the day. For example, Strata 2 is from 0500 to 1030, so contains 69 five minute blocks. If the average count in Strata 2 for some day was 20, we multiply 20 by 69 to give us a strata total of 1380. We repeat this for each strata in a day, and sum all strata totals to get the daily totals.

A more in depth description of this counting method is described by Bowlby and Gibson in the CSAS document "River Herring Assessment for the Tusket River, Nova Scotia" under the "Escapement" section.

\newpage
Lake Vaughan Fish Ladder Counts

Counts were conducted from April 1 2022 to June 21 2022 at the Lake Vaughan fish ladder (Fig. 1). No counts were done prior to April 1 as the ladder was dewatered and impassable. Counts stopped when the daily total was below 1000 for three days in a row. A total of 1,662,007 +/- 51,040 Alewife, and 8,463 +/- 1,196 Blueback Herring were estimated to have ascended the ladder. 
```{r}
...
The same downstream migration behaviour occurred on June 1st, and persisted until the camera was removed on June 8th. None of those counts are representative of upstream migration, so only counts completed where no downstream migration occurred are presented here.
