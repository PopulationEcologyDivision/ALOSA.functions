...
rec.meta.merge<-subset(rec.meta,select=c(INS_SERIAL_NO,DEPLOY_LAT,DEPLOY_LONG,
...
names(rec.meta.merge)<-c("rec.serial","Lat","Lon","deploy.datetime","recover.datetime","download.datetime")
